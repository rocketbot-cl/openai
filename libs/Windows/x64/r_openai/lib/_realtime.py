...
from r_openai import _legacy_response
from r_openai._types import Body, Omit, Query, Headers, NotGiven, omit, not_given
from r_openai._utils import maybe_transform, async_maybe_transform
from r_openai._base_client import make_request_options
from r_openai.resources.realtime.calls import Calls, AsyncCalls
from r_openai.types.realtime.realtime_session_create_request_param import RealtimeSessionCreateRequestParam
