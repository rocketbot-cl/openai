...
from r_typing_extensions import Annotated, Literal, TypeAliasType, TypeGuard, deprecated, get_args, get_origin
...
if sys.version_info < (3, 11):
    from r_typing_extensions import NotRequired, Required
else:
