...
from r_typing_extensions import Literal, override, get_origin
...
class _DefaultHttpxClient(httpx.Client):
    def __init__(self, **kwargs: Any) -> None:
        ...
        #Agregado debido a cambios en las librerias de OpenAi en version de python 3.13.
        if 'proxies' in kwargs:
            proxy = kwargs.pop('proxies')
            if proxy is not None:
                kwargs['proxy'] = proxy if not isinstance(proxy, dict) else next(iter(proxy.values()), None)
