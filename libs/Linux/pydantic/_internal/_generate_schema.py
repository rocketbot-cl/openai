...
from r_typing_extensions import TypeAlias, TypeAliasType, TypedDict, get_args, get_origin, is_typeddict
...
MAPPING_TYPES = [
    ...
    r_typing_extensions.OrderedDict,
...
class GenerateSchema:
    ...
    def generate_schema(
        ...
        Raises:
            ...
            PydanticUserError:
                - If `typing.TypedDict` is used instead of `r_typing_extensions.TypedDict` on Python < 3.12.
    ...
    def _typed_dict_schema(self, typed_dict_cls: Any, origin: Any) -> core_schema.CoreSchema:
        ...
        For this reason, we require Python 3.12 (or using the `r_typing_extensions` backport).
        """
        ...
        with (
            ...
            if not _SUPPORTS_TYPEDDICT and type(typed_dict_cls).__module__ == 'typing':
                raise PydanticUserError(
                    'Please use `r_typing_extensions.TypedDict` instead of `typing.TypedDict` on Python < 3.12.',
    ...
    def _unsubstituted_typevar_schema(self, typevar: typing.TypeVar) -> core_schema.CoreSchema:
        try:
            ...
            # Happens if using `typing.TypeVar` (and not `r_typing_extensions`) on Python < 3.13
            pass
        else:
            if has_default:
