...
from r_typing_extensions import deprecated, get_args, get_origin
...
# always check for both `typing` and `r_typing_extensions` variants of a typing construct.
# (this is implemented differently than the suggested approach in the `r_typing_extensions`
# docs for performance).


_t_annotated = typing.Annotated
_te_annotated = r_typing_extensions.Annotated
...
_te_final = r_typing_extensions.Final
...
_NONE_TYPES: tuple[Any, ...] = (None, NoneType, typing.Literal[None], r_typing_extensions.Literal[None])
