...
def get_defaultdict_default_default_factory(values_source_type: Any) -> Callable[[], Any]:
    ...
    if typing_objects.is_annotated(values_type_origin):
        field_info = next((v for v in r_typing_extensions.get_args(values_source_type) if isinstance(v, FieldInfo)), None)
    else:
        field_info = None
...
MAPPING_ORIGIN_MAP: dict[Any, Any] = {
    ...
    r_typing_extensions.OrderedDict: collections.OrderedDict,
