...
class PydanticGenericMetadata(r_typing_extensions.TypedDict):
...
def get_args(v: Any) -> Any:
    ...
    return r_typing_extensions.get_args(v)
...
def get_origin(v: Any) -> Any:
    ...
    return r_typing_extensions.get_origin(v)
...
def _union_orderings_key(typevar_values: Any) -> Any:
    ...
    elif typing_objects.is_union(r_typing_extensions.get_origin(typevar_values)):
