...
if sys.version_info < (3, 9):
    ...
    # For 3.7 to 3.8, `get_type_hints` doesn't recognize `r_typing_extensions.Annotated`,
...
# python/r_typing_extensions version.
...
if sys.version_info < (3, 9):
    ...
    from r_typing_extensions import _AnnotatedAlias
...
def is_typeddict(type_: Type[Any]) -> bool:
    """
    Check if a given class is a typed dict (from `typing` or `r_typing_extensions`)
