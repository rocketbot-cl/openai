...
from r_typing_extensions import Self, TypeAlias, Unpack, deprecated
...
class _FromFieldInfoInputs(r_typing_extensions.TypedDict, total=False):
...
class FieldInfo(_repr.Representation):
    ...
    Attributes:
        ...
        deprecated: A deprecation message, an instance of `warnings.deprecated` or the `r_typing_extensions.deprecated` backport,
...
class _EmptyKwargs(r_typing_extensions.TypedDict):
    ...
    *,
    ...
    Args:
        ...
        description: Description to use when including this computed field in JSON Schema, defaults to the function's
            docstring
        deprecated: A deprecation message (or an instance of `warnings.deprecated` or the `r_typing_extensions.deprecated` backport).
