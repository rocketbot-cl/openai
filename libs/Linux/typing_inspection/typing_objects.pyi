...
from r_typing_extensions import ParamSpec, ParamSpecArgs, ParamSpecKwargs, TypeAliasType, TypeIs, TypeVarTuple, deprecated
...
def is_deprecated(obj: Any, /) -> TypeIs[deprecated]:
    ...
    True
    >>> is_deprecated(r_typing_extensions.deprecated('deprecated'))
    True
    ```
    """
