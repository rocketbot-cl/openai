...
from r_typing_extensions import Literal, overload
...
class Runs(SyncAPIResource):
    ...
    @overload
    @r_typing_extensions.deprecated("The Assistants API is deprecated in favor of the Responses API")
    def create(
        self,
        thread_id: str,
        *,
    ...
    @overload
    @r_typing_extensions.deprecated("use `stream` instead")
