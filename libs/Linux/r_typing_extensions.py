...
if sys.version_info >= (3, 11):
    ...
    class _AnyMeta(type):
        def __instancecheck__(self, obj):
            if self is Any:
                raise TypeError("r_typing_extensions.Any cannot be used with isinstance()")
            return super().__instancecheck__(obj)

        def __repr__(self):
            if self is Any:
                return "r_typing_extensions.Any"
...
class _SpecialForm(typing._Final, _root=True):
    ...
    def __repr__(self):
        return f'r_typing_extensions.{self._name}'
...
class _ExtensionsSpecialForm(typing._SpecialForm, _root=True):
    def __repr__(self):
        return 'r_typing_extensions.' + self._name
...
if sys.version_info >= (3, 13):
    ...
    # but is necessary to allow typing.Protocol and r_typing_extensions.Protocol
    ...
    class _ProtocolMeta(type(typing.Protocol)):
        ...
        def __eq__(cls, other):
            ...
            # treats r_typing_extensions.Protocol
...
if hasattr(typing, "NoDefault"):
    ...
    class NoDefaultType(metaclass=SingletonMeta):
        ...
        def __repr__(self):
            return "r_typing_extensions.NoDefault"
...
if hasattr(typing, "NoExtraItems"):
    ...
    class NoExtraItemsType(metaclass=SingletonMeta):
        ...
        def __repr__(self):
            return "r_typing_extensions.NoExtraItems"
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _clean_optional(obj, hints, globalns=None, localns=None):
        ...
        # see https://github.com/python/r_typing_extensions/issues/310
...
def _set_module(typevarlike):
    ...
    if def_mod != 'r_typing_extensions':
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(cls, /):
        ...
        Examples::
            ...
            from r_typing_extensions import NamedTuple, TypedDict
...
# <=3.13
    ...
    class TypeAliasType:
        ...
        def __init_subclass__(cls, *args, **kwargs):
            raise TypeError(
                "type 'r_typing_extensions.TypeAliasType' is not an acceptable base type"
            )
...
if hasattr(typing, "is_protocol"):
    ...
    def is_protocol(tp: type, /) -> bool:
        ...
        Example::
            ...
            >>> from r_typing_extensions import Protocol, is_protocol
            >>> class P(Protocol):
            ...     def a(self) -> str: ...
            ...     b: int
            >>> is_protocol(P)
    ...
    def get_protocol_members(tp: type, /) -> typing.FrozenSet[str]:
        ...
        Example::
            ...
            >>> from r_typing_extensions import Protocol, get_protocol_members
            >>> class P(Protocol):
            ...     def a(self) -> str: ...
            ...     b: int
...
if hasattr(typing, "Doc"):
    ...
    class Doc:
        ...
        Example::
            ...
            >>> from r_typing_extensions import Annotated, Doc
    ...
    def get_annotations(obj, *, globals=None, locals=None, eval_str=False,
        ...
        * STRING: return annotations as strings, in a format close to the original
        ...
        want to support earlier Python versions, to simply write:
            ...
            r_typing_extensions.get_annotations(obj, format=Format.FORWARDREF)
...
_typing_names = [
    ...
    "no_type_check",
    "no_type_check_decorator",
    # This is private, but it was defined by r_typing_extensions for a long time
