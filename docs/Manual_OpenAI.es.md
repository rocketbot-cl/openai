...
|Temperatura|Por defecto 0. Valor entre 0 y 2. Cuanto mayor sea el valor, las respuestas serán más creativas, pero también pueden llegar a ser más incoherentes. Dejar vacio al usar modelos de razonamiento (o1, o3, gpt-5, etc.) al estos usar automaticamente 1 de temperatura.|0|
|Cantidad de respuestas|Cuántas opciones de finalización de chat se generan para cada mensaje de entrada.|1|
|Longitud de la respuesta|Longitud máxima de la respuesta. Por defecto 256. Los modelos de razonamiento (o1, o3, gpt-5, etc.) pueden devolver respuestas vacías si no se pone un valor alto, pudiendo llegar a necesitar 8000.|256|
|Secuencia de fin|Secuencia de texto opcional en la cual si aparece, la respuesta se detiene.| |
